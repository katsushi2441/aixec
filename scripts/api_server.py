...
WORKER_SCHEDULE = [
    ...
    {"time": "01:30", "name": "register_market_worker", "server": "this", "ollama": False},
    {"time": "01:20", "name": "buzblogger-enqueue", "server": "this", "ollama": False},
    {"time": "03:00", "name": "growth-agent",       "server": "this",  "ollama": True},
    ...
    {"time": "13:30", "name": "register_market_worker", "server": "this", "ollama": False},
    {"time": "13:20", "name": "buzblogger-enqueue", "server": "this", "ollama": False},
    {"time": "15:00", "name": "growth-agent",       "server": "this",  "ollama": True},
    {"time": "16:30", "name": "horizon_worker",     "server": "this",  "ollama": True},
            ...
            if path == '/schedule':
                schedule = {
                    ...
                    "workers": [
                        ...
                        {"time": "01:30", "name": "register_market_worker", "server": "this", "ollama": False, "note": "楽天ランキング未登録商品を登録"},
                        {"time": "03:00", "name": "growth-agent",      "server": "this",  "ollama": True,  "hermes": "2fc0d9ebb81f"},
                        ...
                        {"time": "13:30", "name": "register_market_worker", "server": "this", "ollama": False, "note": "楽天ランキング未登録商品を登録"},
                        {"time": "15:00", "name": "growth-agent",      "server": "this",  "ollama": True,  "hermes": "2fc0d9ebb81f"},
                        {"time": "16:30", "name": "horizon_worker",    "server": "this",  "ollama": True},
