...
<?php elseif ($video_path): ?>
  <div class="player-grid">
    ...
    <aside class="meta">
      <?php if ($rakuten_url !== ''): ?><a class="cover-link" href="<?php echo h($rakuten_url); ?>" target="_blank" rel="nofollow sponsored noopener"><?php endif; ?>
      <img class="cover" src="<?php echo h($image_url); ?>" alt="<?php echo h($title); ?>">
      <?php if ($rakuten_url !== ''): ?></a><?php endif; ?>
      ...
      <div class="actions">
        <?php if ($rakuten_url !== ''): ?><a class="btn buy" href="<?php echo h($rakuten_url); ?>" target="_blank" rel="nofollow sponsored noopener">楽天市場で見る</a><?php endif; ?>
